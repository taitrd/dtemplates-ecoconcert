  ...
  return (
    <section className="py-20 bg-background/30 px-4 md:px-6 rounded-3xl border border-border/50">
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          <h2 className="text-3xl md:text-5xl font-bold mb-4 tracking-tight">This Week's Highlights</h2>
          <p className="text-muted-foreground text-lg max-w-2xl">
            Check out the most anticipated concerts happening in the next 7 days.
          </p>
        </div>
        ...
        {loading ? (
                  ...
                  <div className="group relative bg-card rounded-2xl overflow-hidden border border-border shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    <div className="relative aspect-[3/4]">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-primary/90 backdrop-blur-md px-4 py-3 flex items-center justify-between">
                        ...
                        <CountdownTimer days={concert.days} className="text-primary-foreground font-mono font-bold" />
                      </div>
                    </div>
                    <div className="p-5 space-y-3">
                      <div className="flex justify-between items-start">
                        <h3 className="text-xl font-bold leading-tight">{concert.singer}</h3>
          ...
          <div className="text-center py-20 bg-muted/20 rounded-2xl border border-dashed border-border">
            <p className="text-muted-foreground italic">No highlights for this week.</p>
          </div>
        )}
      </div>
    </section>
