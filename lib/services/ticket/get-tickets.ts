import { Concert, SearchFilters } from '@/lib/types/ticket';
...
const mockConcerts: Concert[] = [
  ...
  },
  {
    ...
    price: 120,
    image: 'https://images.unsplash.com/photo-1514525253361-bee8a1874281?q=80&w=1000&auto=format&fit=crop',
...
export async function getConcerts(filters?: SearchFilters): Promise<Concert[]> {
  ...
  if (filters?.date) {
    ...
    filtered = filtered.filter((c) => new Date(c.date).toDateString() === filterDate);
  }
